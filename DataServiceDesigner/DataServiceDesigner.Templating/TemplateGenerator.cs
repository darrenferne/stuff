...
namespace DataServiceDesigner.Templating
{
    public class TemplateGenerator
    {
        ...
        {
            outputFolder = Path.Combine(outputFolder, $"Brady.{dataService.Name}.Domain");
            ...
            File.WriteAllText(Path.Combine(outputFolder, $"Brady.{dataService.Name}.Domain.csproj"), content);
        ...
        {
            outputFolder = Path.Combine(outputFolder, $"Brady.{dataService.Name}.DataService");
            ...
            projectTemplate.Initialize();
            string content = projectTemplate.TransformText();
            File.WriteAllText(Path.Combine(outputFolder, $"Brady.{dataService.Name}.DataService.csproj"), content);
        ...
        public void GenerateDataServiceHostProject(DomainDataService dataService, string outputFolder)
        {
            outputFolder = Path.Combine(outputFolder, $"Brady.{dataService.Name}.DataService.Host");
            ...
            projectTemplate.Initialize();
            string content = projectTemplate.TransformText();
            File.WriteAllText(Path.Combine(outputFolder, $"Brady.{dataService.Name}.DataService.Host.csproj"), content);
        ...
        public void GenerateSolution(DomainDataService dataService, string outputFolder)
        {
