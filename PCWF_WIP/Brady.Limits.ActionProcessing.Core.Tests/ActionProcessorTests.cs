    ...
    public class ActionProcessorTests : TestKit
    {
        class TestRequirements : IActionProcessorRequirements
        {
            public TestRequirements()
            {
                ...
                IActionProcessingStateChange SideQuest(ActionRequest<IntegerPayload> r) => LastState = new SuccessStateChange(r.Payload, r.CurrentState);
        ...
        public void Sending_an_valid_process_action_request_for_a_valid_state_should_succeed()
        {
            ...
            Assert.AreEqual("Level1", ((ActionResponse)response).StateChange.NewState.CurrentState);
        ...
        public void Progressing_through_valid_states_should_succeed()
        {
            ...
            Assert.AreEqual("Level2", ((ActionResponse)response).StateChange.NewState.CurrentState);
            ...
            Assert.AreEqual("Level3", ((ActionResponse)response).StateChange.NewState.CurrentState);
            ...
            Assert.AreEqual(typeof(ActionResponse), response.GetType());
            Assert.AreEqual(((IActionRequest)response.Request).CurrentState.CurrentState, ((ActionResponse)response).StateChange.NewState.CurrentState);
            ...
            Assert.AreEqual("Complete", ((ActionResponse)response).StateChange.NewState.CurrentState);
            ...
            Assert.AreEqual("Start", ((ActionResponse)response).StateChange.NewState.CurrentState);
        }
