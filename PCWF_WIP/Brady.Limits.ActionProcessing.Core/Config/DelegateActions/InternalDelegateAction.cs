...
namespace Brady.Limits.ActionProcessing.Core
{
    ...
    public class InternalDelegateAction<TPayload> : AllowedAction<TPayload>, IInternalAction
        where TPayload : class, IActionRequestPayload
    {
        ...
        public InternalDelegateAction(string name, Func<IActionRequest<TPayload>, IActionProcessingStateChange> onInvoke, Func<IActionRequest<TPayload>, bool> canInvoke = null)
            : base(name)
        {
            if (onInvoke is null)
